...
A more aggressive enlargement to $\Delta t = 1\,\mathrm{h}$ would
sit at the edge of the $\Phi$-burst-resolution constraint and would
require a verification run -- a drift-parity test against the
$15$-minute reference at the same truth point and the same Wiener
realisation -- before being adopted in production. We do not
