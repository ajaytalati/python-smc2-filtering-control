...
the \texttt{FSA\_STEP\_MINUTES} environment variable. Cross-grid
sanity checks pass and the LQG controller of
Section~\ref{sec:mpc-lqg} agrees to within $0.5\%$ of its
$15$-minute reference (Table~\ref{tab:lqg-horizons}); the
end-to-end speedup is roughly $4\times$. The corresponding
$1$-hour SMC${}^2$ MPC validation run at $T = 14$ d closes the
remaining gate. We do not
