...
core of the document: it develops the receding-horizon principle and
...
controller; Stage~I's $1$-hour outer step is also reported.
Section~\ref{sec:discussion} closes by reviewing the identifiability
and stability analyses, and by collecting the remaining open
questions. Appendix~\ref{app:lqg} records, for completeness only, a
linear-quadratic-Gaussian baseline whose poor performance on this
plant is taken as evidence that the cubic Stuart--Landau
