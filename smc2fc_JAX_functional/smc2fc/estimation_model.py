"""Interface contract for Bayesian SDE estimation.

Frozen dataclass that defines what a model must provide for the
generic differentiable particle filter + MCLMC sampler. Mirrors
:class:`smc2fc.simulator.sde_model.SDEModel` for the simulator side.

Already-pure in the imperative source; this module is unchanged in
semantics.
"""
