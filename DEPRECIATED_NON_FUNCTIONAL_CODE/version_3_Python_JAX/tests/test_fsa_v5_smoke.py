...
def test_v5_imports_clean():
    ...
    import version_3_Python_JAX.models.fsa_v5 as fh
...
def test_v5_plant_forward_pipeline():
    ...
    from version_3_Python_JAX.models.fsa_v5 import StepwisePlant, DEFAULT_PARAMS_V5
...
def test_v5_estimation_propagate_fn_runs():
    ...
    from version_3_Python_JAX.models.fsa_v5 import HIGH_RES_FSA_V5_ESTIMATION
...
def test_v5_chance_constrained_cost_smoke():
    ...
    from version_3_Python_JAX.models.fsa_v5 import (
...
def _build_smoke_cloud(n_particles=5, n_days=14):
    ...
    from version_3_Python_JAX.models.fsa_v5 import TRUTH_PARAMS_V5
    particles = [dict(TRUTH_PARAMS_V5) for _ in range(n_particles)]
    weights = np.ones(n_particles) / n_particles
...
def test_v5_cost_hard_jits():
    ...
    from version_3_Python_JAX.models.fsa_v5.control_v5 import evaluate_chance_constrained_cost_hard
...
def test_v5_cost_soft_jits():
    ...
    from version_3_Python_JAX.models.fsa_v5.control_v5 import evaluate_chance_constrained_cost_soft
