...
def test_jax_find_A_sep_differs_per_particle():
    ...
    import jax
    import jax.numpy as jnp
    from version_3_Python_JAX.models.fsa_v5.control_v5 import _jax_find_A_sep
...
def test_compute_cost_internals_returns_per_particle_A_sep():
    ...
    import jax.numpy as jnp
    from version_3_Python_JAX.models.fsa_v5.control_v5 import _compute_cost_internals
...
def test_hard_cost_indicator_uses_per_particle_separator():
    ...
    """
    import jax.numpy as jnp
    from version_3_Python_JAX.models.fsa_v5.control_v5 import _cost_hard_jit
...
def test_soft_cost_indicator_uses_per_particle_separator():
    ...
    import jax.numpy as jnp
    from version_3_Python_JAX.models.fsa_v5.control_v5 import _cost_soft_jit
