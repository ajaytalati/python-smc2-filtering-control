...
def _allocate_run_dir(repo_root: Path, run_tag: str) -> tuple[Path, int]:
    ...
    from version_3_Python_JAX.tools._run_dir import allocate_run_dir
...
def _build_cost_chance_constrained(
    *,
    ...
    from version_3_Python_JAX.models.fsa_v5.control_v5 import (
        _cost_soft_jit, _cost_hard_jit, _stack_particle_dicts,
        _ensure_v5_keys,
    )
    from version_3_Python_JAX.models.fsa_v5.control_v5_fast import _cost_soft_fast_jit
    from version_3_Python_JAX.models.fsa_v5._dynamics import TRUTH_PARAMS_V5
...
def _build_spec_for_cost_variant(
    *, cost: str, n_steps: int, n_anchors: int,
    ...
    if cost in ('soft', 'hard', 'soft_fast'):
        ...
        from version_3_Python_JAX.models.fsa_v5.control import build_control_spec_v5
...
def main():
    ...
    from version_3_Python_JAX.models.fsa_v5._plant import StepwisePlant
    from version_3_Python_JAX.models.fsa_v5.simulation import DEFAULT_PARAMS_V5
    from version_3_Python_JAX.models.fsa_v5.control_v5 import (
    ...
    if cost == 'gradient_ot':
        from version_3_Python_JAX.models.fsa_v5.control_v5 import evaluate_chance_constrained_cost_hard as posthoc_eval
    else:
        from version_3_Python_JAX.models.fsa_v5.control_v5 import evaluate_chance_constrained_cost_hard as posthoc_eval
    ...
    try:
        from version_3_Python_JAX.tools.plot_basin_overlay import plot_basin_overlay
        plot_basin_overlay(
